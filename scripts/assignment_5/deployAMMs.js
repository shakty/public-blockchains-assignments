...
async function main() {
    ...
    async function deployAMM(idx=0) {
        ...
        console.log("Approving validator to spend coins...");
        
        const tx = await coinContract.approve(validatorAddress, balance.toString());
        await tx.wait();
        ...
        console.log("Registering AMM in the registry...");
        const tx2 = await registryContract.registerAMM(ammAddress);
        await tx2.wait();
        console.log("AMM registered in the registry.");
